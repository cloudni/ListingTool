...
class eBayEntityType extends NIAdminActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, entity_table, entity_model, attribute_table, attribute_model, value_table', 'required'),
            array('entity_table','unique'),
            array('entity_model','unique'),
			array('name, entity_table, entity_model, attribute_table, attribute_model, value_table, value_model', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, entity_table, entity_model, attribute_table, attribute_model, value_table, value_model, create_time_utc, create_admin_id, update_time_utc, update_admin_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
        ...
        $criteria->compare('value_table',$this->value_table,true);
        $criteria->compare('value_model',$this->value_model,true);
