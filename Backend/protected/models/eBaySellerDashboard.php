...
/**
 * This is the model class for table "{{ebay_seller_dashboard}}".
 *
 * The followings are the available columns in table '{{ebay_seller_dashboard}}':
 * @property integer $id
 ...
 */
class eBaySellerDashboard extends NIAdminActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('store_id, ebay_entity_type_id, ebay_attribute_set_id', 'numerical', 'integerOnly'=>true),
			array('name, note', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, store_id, ebay_entity_type_id, ebay_attribute_set_id, note', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return eBaySellerDashboard the static model class
	 */
