...
/**
 * This is the model class for table "{{ebay_user}}".
 *
 * The followings are the available columns in table '{{ebay_user}}':
 * @property integer $id
 ...
 */
class eBayUser extends NIAdminActiveRecord
{
	/**
	 ...
	 * @return eBayUser the static model class
	 */
