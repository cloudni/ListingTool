...
Yii::import('application.vendor.Wish.Exception.*');
Yii::import('application.vendor.Wish.Model.*');
Yii::import('application.vendor.Wish.*');
require_once 'UnauthorizedRequestException.php';
require_once 'ServiceResponseException.php';
require_once 'OrderAlreadyFulfilledException.php';
require_once 'WishProduct.php';
require_once 'WishProductVariation.php';
require_once 'WishOrder.php';
require_once 'WishTracker.php';
require_once 'WishReason.php';
require_once 'WishSession.php';
require_once 'WishRequest.php';
require_once 'WishResponse.php';
require_once 'WishPager.php';
...
class WishClient{
  ...
  private $orders;
    ...
    CONST Session_Type_SandBox='sandbox';
    CONST Session_Type_Prod='prod';

  const LIMIT = 50;

  public function __construct($api_key,$merchant_id=null, $session=self::Session_Type_Prod){
