...
DROP TABLE IF EXISTS `lt_ad_campaign_exclude_keyword`;
CREATE TABLE `lt_ad_campaign_exclude_keyword` (
  `id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  `company_id` INT NOT NULL,
  `ad_campaign_id` INT NOT NULL,
...
DROP TABLE IF EXISTS `lt_ad_group_exclude_keyword`;
CREATE TABLE `lt_ad_group_exclude_keyword` (
  `id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  `company_id` INT NOT NULL,
  `ad_group_id` INT NOT NULL,
  `keyword` VARCHAR(500) NOT NULL,
