...
class DepartmentController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
           /* var_dump($_POST,$_POST['Department']['userId']);die();*/

			$model->attributes=$_POST['Department'];
            $model->company_id = Yii::app()->session['user']->company_id;
            if($model->register($_POST['Department']))
                $this->redirect($this->createAbsoluteUrl("department/view", array('id'=>$model->id)));
		}
	...
	{
		$model=Department::model()->findByPk($id, "company_id=:company_id" ,array(':company_id' => Yii::app()->session['user']->company_id));
		if($model===null)
