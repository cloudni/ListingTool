 ...
 */
class Ticket extends NIActiveRecord
{
	...
	{
		return array(
			'id' => Yii::t('models/Ticket','ID'),
			'title' => Yii::t('models/Ticket','Title'),
			'content' => Yii::t('models/Ticket','Content') ,
			'type' => Yii::t('models/Ticket','Type'),
			'is_repliable' => Yii::t('models/Ticket','Is Repliable'),
			'is_viewable' => Yii::t('models/Ticket','Is Viewable'),
			'parent_id' => Yii::t('models/Ticket','Parent'),
			...
			'is_user' => Yii::t('models/User','Is User'),
            'is_new' => Yii::t('models/User','Is New'),
		);
	}
