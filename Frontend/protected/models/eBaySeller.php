...
/**
 * This is the model class for table "{{ebay_seller}}".
 *
 * The followings are the available columns in table '{{ebay_seller}}':
 * @property integer $id
 ...
 */
class eBaySeller extends NIAdminActiveRecord
{
	/**
	 ...
	 * @return eBaySeller the static model class
	 */
