...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'create_admin_id'); ?>
		<?php echo $form->textField($model,'create_admin_id'); ?>
		<?php echo $form->error($model,'create_admin_id'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'update_admin_id'); ?>
		<?php echo $form->textField($model,'update_admin_id'); ?>
		<?php echo $form->error($model,'update_admin_id'); ?>
	</div>
