                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    ...
                    <?php if(isset($performances) && !empty($performances)):?>
                        <?php foreach($performances as $performance):?>
                            ...
                            <tr>
                                <td><img keyword="<?php echo $performance['keyword_text'];?>" action="<?php echo $performance["campaign_exclude_id"] ?  "include" : "exclude";?>" src="<?php echo $performance["campaign_exclude_id"] ?  "/images/addicon.gif" : "/images/delicon.gif";?>" onclick="updateKeywordSetting('<?php echo $performance['keyword_text'];?>', this);" /></td>
...
<script>
    ...
    function updateKeywordSetting(keyword, obj)
    {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo Yii::app()->createAbsoluteUrl("marketing/advertisement/ADCampaign/updateKeywordSetting");?>',
            data: {
                keyword: keyword,
