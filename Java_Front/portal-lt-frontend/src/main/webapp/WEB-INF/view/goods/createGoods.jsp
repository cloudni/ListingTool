...
<form id="store-form" action="${phpPath }/store/create" method="post">
    ...
    <div class="container">
        ...
        <div class="row left">
            <input class="greenButton" style="font-size: 12px; width: 90px;" type="submit" name="yt0" value="AddGoods" />
            <input class="greenButton" style="font-size: 12px; width: 120px;" type="submit" name="yt0" value="VerifyAddGoods" />
        </div>
    </div>
