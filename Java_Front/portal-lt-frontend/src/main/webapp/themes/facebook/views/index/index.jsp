                ...
                <div style="width: 100%; padding: 0px; margin: 0px;">
                    ...
                    <div class="lfloat">
                        ...
                        <div style="font-size: 12px; height: 20px; vertical-align: middle; padding-top: 10px;">2.
                            <a href="${ctxPath}/themes/facebook/views/index/createUser.jsp">Create more user</a>&nbsp;Or&nbsp;
                            <a href="${ctxPath}/themes/facebook/views/index/listUser.jsp">Manage current users</a>                        </div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div style="width: 100%; padding: 0px; margin: 0px;">
                    ...
                    <div class="lfloat">
                        ...
                        <div style="font-size: 12px; height: 20px; vertical-align: middle; padding-top: 10px;">3.
                            <a href="${ctxPath}/themes/facebook/views/index/createStore.jsp">Create more store</a>&nbsp;Or&nbsp;
                            <a href="${ctxPath}/themes/facebook/views/index/listStore.jsp">Manage current stores</a>                        </div>
                    </div>
                </div>
            </div>
        </div>
