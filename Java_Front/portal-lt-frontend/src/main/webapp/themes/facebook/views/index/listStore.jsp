...
<a href="${phpPath }">首页</a> &raquo; <span>商店</span></div><!-- breadcrumbs -->
...
<li><a href="${ctxPath}/themes/facebook/views/index/createStore.jsp">新建商店</a></li>
</ul></div>
</div>        </div><!-- sidebar -->
    </div>
		...
		<div>
			<div style="background: #f6f7f8; border-bottom: 1px solid #e9eaed; font-size: 12px;">
				<div style="height: 36px; color: #9197a3; font-weight: normal;">
					<h1 style="color: #4e5665; font-weight: 700; padding-left: 14px; line-height: 38px; position: relative;">商店</h1>
				</div>
			</div>
...
<div class="view">
	...
	<b>名称:</b>
    <a href="${phpPath }/store/1">LOF ebay-fl</a>	<br />
...
<div class="view">
	...
	<b>名称:</b>
    <a href="${phpPath }/store/2">LOF ebay-discount</a>	<br />
...
<div class="view">
	...
	<b>名称:</b>
    <a href="${phpPath }/store/3">hjv.kjb/l</a>	<br />
