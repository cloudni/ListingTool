                        ...
                        <div class="menu_login_container rfloat">
                            <form id="SignIn-form" action="${phpPath }/site/signIn" method="post" style="margin-right: 10px;">
                                <table cellspacing="0" style="display: table; border-collapse: separate; border-spacing: 0px; border-color: gray;padding-top: 12px;">
                                    ...
                                    <tr>
                                        <td style="background: #3a5795;"><label for="email" style="color: #fff; font-weight: normal; padding-left: 1px;">用户名</label></td>
                                        <td style="background: #3a5795;"><label for="pass" style="color: #fff; font-weight: normal; padding-left: 1px;">密&nbsp;&nbsp;码</label></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="background: #3a5795;"><label class="uiButton uiButtonConfirm" id="loginbutton" for="u_0_n"><input value="登录" tabindex="4" type="button" id="u_0_n" onclick="local.href='/themes/facebook/views/index/index.jsp';"></label></td>
                                    </tr>
                                    <tr>
                                        <td class="login_form_label_field" style="position: relative; left: -4px;"><input id="persist_box" type="checkbox" name="SignInForm[rememberMe]" id="SignInForm_rememberMe" value="1" tabindex="3" class="uiInputLabelInput uiInputLabelCheckbox"><label for="persist_box" class="uiInputLabelLabel" style="position: relative;top: -3px;">自动登录</label></td>
                                        <td class="login_form_label_field"><a href="${phpPath }/site/forgotPwd">忘记密码?</a></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </form>
...
<div class="container clearfix">
    ...
    <div class="lfloat" style="display: inline-block; vertical-align: top; width: 415px; line-height: 120%; ">
        <h2 class="boldFont indexSlogan" style="font-size: 36px; padding: 0px;">注册</h2>
                    ...
                    <div>
                            ...
                            <div style="margin-right: 8px; margin-bottom: 10px; ">
                                <div style="position: relative; width: 415px;">
                                    <div style="width: 415px; height: 40px; background: white; -webkit-border-radius: 5px; display: inline-block; position: relative;">
                                        <div class="placeholder" style="font-size: 20px; top: 5px; padding: 8px 10px; -webkit-box-sizing: border-box; overflow: hidden;text-overflow: ellipsis; white-space: nowrap;">用户名</div>
                        ...
                        <div style="width: 100%;">
                            <div style="margin-right: 8px; margin-bottom: 10px; ">
                                <div style="position: relative; width: 415px;">
                                    <div style="width: 415px; height: 40px; background: white; -webkit-border-radius: 5px; display: inline-block; position: relative;">
                                        <div class="placeholder" style="font-size: 20px; top: 5px; padding: 8px 10px; -webkit-box-sizing: border-box; overflow: hidden;text-overflow: ellipsis; white-space: nowrap;">邮件地址</div>
                            ...
                            <div style="margin-right: 8px; margin-bottom: 10px; ">
                                <div class="lfloat" style="position: relative;">
                                    <div style="width: 194px; height: 40px; background: white; -webkit-border-radius: 5px; display: inline-block; position: relative;">
                                        <div class="placeholder" style="font-size: 20px; top: 5px; padding: 8px 10px; -webkit-box-sizing: border-box; overflow: hidden;text-overflow: ellipsis; white-space: nowrap;">密&nbsp;&nbsp;码</div>
                                ...
                                <div class="lfloat" style="position: relative; left: 27px;">
                                    <div style="width: 194px; height: 40px; background: white; -webkit-border-radius: 5px; display: inline-block; position: relative;">
                                        <div class="placeholder" style="font-size: 20px; top: 5px; padding: 8px 10px; -webkit-box-sizing: border-box; overflow: hidden;text-overflow: ellipsis; white-space: nowrap;">确认密码</div>
                        ...
                        <div style="width: 100%; margin-top: 70px;">
                            <div style="margin-right: 8px; margin-bottom: 10px; ">
                                <div style="color: #141823; font-size: 18px; font-weight: normal;">公司信息</div>
                            </div>
                        </div>
                        <div style="width: 100%;">
                            <div style="margin-right: 8px; margin-bottom: 10px; ">
                                <div style="position: relative; width: 415px;">
                                    <div style="width: 415px; height: 40px; background: white; -webkit-border-radius: 5px; display: inline-block; position: relative;">
                                        <div class="placeholder" style="font-size: 20px; top: 5px; padding: 8px 10px; -webkit-box-sizing: border-box; overflow: hidden;text-overflow: ellipsis; white-space: nowrap;">公司名称</div>
                        ...
                        <div style="width: 100%;">
                            <div style="margin-right: 8px; margin-bottom: 10px; ">
                                <div style="position: relative; width: 415px;">
                                    <div style="width: 415px; height: 40px; background: white; -webkit-border-radius: 5px; display: inline-block; position: relative;">
                                        <div class="placeholder" style="font-size: 20px; top: 5px; padding: 8px 10px; -webkit-box-sizing: border-box; overflow: hidden;text-overflow: ellipsis; white-space: nowrap;">电话号码</div>
                        ...
                        <div style="width: 100%;">
                            <div style="margin-right: 8px; margin-bottom: 10px; ">
                                <div style="position: relative; width: 415px;">
                                    <div style="width: 415px; height: 40px; background: white; -webkit-border-radius: 5px; display: inline-block; position: relative;">
                                        <div class="placeholder" style="font-size: 20px; top: 5px; padding: 8px 10px; -webkit-box-sizing: border-box; overflow: hidden;text-overflow: ellipsis; white-space: nowrap;">国家或地区</div>
                        ...
                        <div style="width: 100%;">
                            <div style="margin-right: 8px; margin-bottom: 10px; ">
                                <p style="color: #777; font-size: 11px; width: 316px;">点击注册按钮，代表您已经阅读并同意我们的注册协议，授权并使用您的数据及Cookies等。</p>
                            </div>
                        </div>
                        <div class="clearfix" style="width: 100%;">
                            <button type="submit" name="websubmit" class="boldFont greenButton" style="margin-top: 10px; margin-bottom: 10px; min-width: 194px; padding: 7px 20px; -webkit-border-radius: 5px;">注册</button>
                        </div>
                    </div>
                </form>
            </div>
