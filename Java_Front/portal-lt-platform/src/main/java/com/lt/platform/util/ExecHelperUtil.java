...
public final class ExecHelperUtil {
	 ...
	 * @return The results of the execution in an ExecHelperUtil object.
	 ...
	 */
	public static ExecHelperUtil exec(String[] cmdarray) throws IOException {
		return new ExecHelperUtil(Runtime.getRuntime().exec(cmdarray), null);
	}
	 ...
	 * @since ostermillerutils 1.06.00
	 */
	public static ExecHelperUtil exec(String[] cmdarray, String[] envp) throws IOException {
		return new ExecHelperUtil(Runtime.getRuntime().exec(cmdarray, envp), null);
	}
	 ...
	 * @since ostermillerutils 1.06.00
	 */
	public static ExecHelperUtil exec(String[] cmdarray, String[] envp, File dir) throws IOException {
		return new ExecHelperUtil(Runtime.getRuntime().exec(cmdarray, envp), null);
	}
	 ...
	 * @since ostermillerutils 1.06.00
	 */
	public static ExecHelperUtil exec(String[] cmdarray, String charset) throws IOException {
		return new ExecHelperUtil(Runtime.getRuntime().exec(cmdarray), charset);
	}
	 ...
	 * @since ostermillerutils 1.06.00
	 */
	public static ExecHelperUtil exec(String[] cmdarray, String[] envp, String charset) throws IOException {
		return new ExecHelperUtil(Runtime.getRuntime().exec(cmdarray, envp), charset);
	}
	 ...
	 * @since ostermillerutils 1.06.00
	 */
	public static ExecHelperUtil exec(String[] cmdarray, String[] envp, File dir, String charset) throws IOException {
		return new ExecHelperUtil(Runtime.getRuntime().exec(cmdarray, envp), charset);
	}
	 ...
	 * @since ostermillerutils 1.06.00
	 */
	public static ExecHelperUtil execUsingShell(String command) throws IOException {
	 ...
	 * @since ostermillerutils 1.06.00
	 */
	public static ExecHelperUtil execUsingShell(String command, String charset) throws IOException {
	 ...
	 * @since ostermillerutils 1.06.00
	 */
	private ExecHelperUtil(Process process, String charset) throws IOException {
