...
import com.lt.platform.util.io.FileUtil;
...
public class FileUploadUtil {
    ...
    public FileUploadUtil(String destinationPath){
    ...
    public boolean Upload(){
        ...
        try {
            ...
            //如果没有上传目的目录，则创建它
            FileUtil.createFileIfNoExists(dstPath);
            //如果没有临时目录，则创建它
            if(StringUtil.isNotEmpty(this.tempPath)){
            	FileUtil.createFileIfNoExists(tempPath);
            }
                    ...
                    if (result) {
                        ...
                        try {
                            ...
                            else
                            {
                                ...
                                FileUtil.createFileIfNoExists(uploadfilename);
