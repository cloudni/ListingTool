...
public class ImageUtil {
	...
	public static void main(String[] args) {
		// 1-缩放图像：
		// 方法一：按比例缩放
		ImageUtil.scale("e:/img/abc.jpg", "e:/img/abc_scale.jpg", 2, true);// 测试OK
		// 方法二：按高度和宽度缩放
		ImageUtil.scale2("e:/img/abc.jpg", "e:/img/abc_scale2.jpg", 500, 300,
				true);// 测试OK

		// 2-切割图像：
		// 方法一：按指定起点坐标和宽高切割
		ImageUtil.cut("e:/img/abc.jpg", "e:/img/abc_cut.jpg", 0, 0, 400, 400);// 测试OK
		// 方法二：指定切片的行数和列数
		ImageUtil.cut2("e:/img/abc.jpg", "e:/img/", 2, 2);// 测试OK
		// 方法三：指定切片的宽度和高度
		ImageUtil.cut3("e:/img/abc.jpg", "e:/img/", 300, 300);// 测试OK

		// 3-图像类型转换：
		ImageUtil.convert("e:/img/abc.jpg", "GIF", "e:/img/abc_convert.gif");// 测试OK

		// 4-彩色转黑白：
		ImageUtil.gray("e:/img/abc.jpg", "e:/img/abc_gray.jpg");// 测试OK

		// 5-给图片添加文字水印：
		// 方法一：
		ImageUtil.pressText("我是水印文字", "e:/img/abc.jpg",
				"e:/img/abc_pressText.jpg", "宋体", Font.BOLD, Color.white, 80,
				0, 0, 0.5f);// 测试OK
		// 方法二：
		ImageUtil.pressText2("我也是水印文字", "e:/img/abc.jpg",
				"e:/img/abc_pressText2.jpg", "黑体", 36, Color.white, 80, 0, 0,
				0.5f);// 测试OK

		// 6-给图片添加图片水印：
		ImageUtil.pressImage("e:/img/abc2.jpg", "e:/img/abc.jpg",
