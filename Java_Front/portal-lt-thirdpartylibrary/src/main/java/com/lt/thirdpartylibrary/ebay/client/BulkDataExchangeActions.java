...
import com.ebay.marketplace.services.CreateRecurringJobRequest;
import com.ebay.marketplace.services.CreateRecurringJobResponse;
import com.ebay.marketplace.services.CreateUploadJobRequest;
import com.ebay.marketplace.services.CreateUploadJobResponse;
import com.ebay.marketplace.services.DeleteRecurringJobRequest;
import com.ebay.marketplace.services.DeleteRecurringJobResponse;
...
import com.ebay.marketplace.services.GetRecurringJobsRequest;
import com.ebay.marketplace.services.GetRecurringJobsResponse;
...
public class BulkDataExchangeActions {
    ...
    private static Logger logger = LoggerFactory.getLogger(" BulkDataExchangeActions.logger");
    
    public BulkDataExchangeActions(String userToken) {
        try {
            call = new BulkDataExchangeCall(LMSResource.getInstance().getBulkDataExchangeURL(), userToken);
            //call = new BulkDataExchangeCall(LMSResource.getInstance().getBulkDataExchangeURL(), LMSResource.getInstance().getReource("userToken"));
        } catch (Exception e) {
